...
- 비트연산자(&) 활용
- Python의 스킬코드 ⇒ 256 = 0001 0000 0000
    - D162 개발자가 가진 스킬코드에 포함되어 있는지 확인해야 함 ⇒ 8452 = 0010 0001 0000 0100 와 같은 위치의 비트가 모두 1일 때만 결과 비트가 1이 될 것 ⇒ 동일 비트가 있음, 즉 해당 스킬이 포함되었다는 뜻
    - 0010 0001 0000 0100
    & 0000 0001 0000 0000
    = 0000 0001 0000 0000